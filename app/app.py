...
def upload_image():
    ...
    if file and allowed_file(file.filename):
        ...
        # Render the results page with the prediction and material analysis
        return render_template('results.html', predicted_class_name=predicted_class_name, material_data=material_data)
